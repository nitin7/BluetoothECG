...
public class AlarmActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final ImageButton button = (ImageButton) findViewById(R.id.submitbutton);
        ...
        final ImageButton button1 = (ImageButton) findViewById(R.id.submitbutton1);
        button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	//if(button.isChecked())
            	//{
                Intent i1 = new Intent(AlarmActivity.this, DynamicGraphActivity.class);
        		startActivity(i1);
            	//}
            	/*
            	else
